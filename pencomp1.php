...
<body>
<div class="top-bar">
  <h2 class="p-3 text-center text-white">Online Grievance System</h2>
</div>
    ...
    <div class="col-sm-2 " style=" background-color:#0c3953;height:615px;">
       ...
       <ul style="font-size: 16px; margin-left:-14%;">
        ...
        <li><a href="adminhome1.php">Back to home</li></a>
        <li><a href="index.php">Logout</li></a></ul>
      </div>
      <iframe src="penframe1.php" style="height:615px;" ></iframe>
    </div>
