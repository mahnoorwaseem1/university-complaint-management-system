...
<div class="row" >
<div class="col-sm-2" >
        <div style="background-color:#094c72;padding:15px;color: white; text-align: center;font-size:17px;">
        <b><label>Manage Complaints</label></b>
        </div>
        <ul style="font-size: 16px; list-style:none;"><br>
        <li><a href="user.php">Create Users</li></a><br><br>
...
if(isset($_POST['create_admin'])){
    ...
    $sql="INSERT INTO `users`(username, email, department, password, role) VALUES ('$username','$email','$department','$password,','$role')";	
    $create_admin = mysqli_query($conn, $sql);
    if(!$create_admin)
	{
...
<form method="post" action="action.php" >
  <table >
	...
	<tr><td><br><input class="form-control" type="password" name="password" value="<?php echo $password; ?>" placeholder="Password"></td></tr>
  <tr><td><br><input class="form-control" type="password" name="pass2" placeholder="Password confirmation"></td></tr>
	<tr><td><br><select class="form-control" name="role">
		<optionv value="<?php echo $username; ?>" selected disabled>Assign role</option>
			<option>Admin</option>
	...
	<?php if ($isEditingUser === true): ?> 
		<button type="submit" class="btn btn-info" name="update_admin">Update User</button>
	<?php else: ?>
		<button type="submit" class="btn btn-info" name="create_admin">Save User</button>
	<?php endif ?>
