...
<div class="top-bar">
  <h2 class="p-3 text-center text-white">University Complaint Management System</h2>
    ...
    <div class="col-sm-2" style=" background-color:#0c3953;height:700px;">
        <div style="background-color:#094c72;padding:22px;color: white; text-align: center;font-size:18px;width:106%;">
    ...
    <iframe src="detframe.php" style="height:650px; width:1250px;"></iframe> 
</div>
</body>
</html>